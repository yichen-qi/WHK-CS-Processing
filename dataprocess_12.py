...
save_folder = r'C:\Users\Admin\Desktop\WHK CS processing\data_excel_12'
...
for file_name in os.listdir(excel_folder):
    if file_name.endswith('.xlsx'):
        ...
        df_avg = pd.concat([pd.DataFrame(matrix_x_3x4.reshape(-1,1)), pd.DataFrame(matrix_z_3x4.reshape(-1,1)), pd.DataFrame(matrix_values_3x4.reshape(-1,1))], axis=1)
        ...
        insert_data = np.tile(numbers, (12, 1))
