...
data_folder_24 = 'data_excel_24'
# data_folder_192 = 'data_excel_192'

ct_48 = Convert_traindata(data_folder_24)
# ct_192 = Convert_traindata(data_folder_192)

inputs_24, outputs_24, co_ind_24 = ct_48.con_td()
# inputs_192, outputs_192, co_ind_192 = ct_192.con_td()


save_folder_path = 'traindata24_npy'
np.save(os.path.join(save_folder_path, 'inputs_24.npy'), inputs_24)
np.save(os.path.join(save_folder_path, 'outputs_24.npy'), outputs_24)
...
np.save(os.path.join(save_folder_path, 'coordinate_index_24.npy'), co_ind_24)
