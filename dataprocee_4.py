...
save_folder = r'C:\Users\Admin\Desktop\WHK CS processing\data_excel_4'
...
for file_name in os.listdir(excel_folder):
    if file_name.endswith('.xlsx'):
        ...
        df_avg = pd.concat([pd.DataFrame(matrix_x_2x2.reshape(-1,1)), pd.DataFrame(matrix_z_2x2.reshape(-1,1)), pd.DataFrame(matrix_values_2x2.reshape(-1,1))], axis=1)
        ...
        insert_data = np.tile(numbers, (4, 1))
