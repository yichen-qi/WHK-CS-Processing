...
data_folder_4 = 'data_excel_4'
# data_folder_192 = 'data_excel_192'

ct_48 = Convert_traindata(data_folder_4)
# ct_192 = Convert_traindata(data_folder_192)

inputs_4, outputs_4, co_ind_4 = ct_48.con_td()
# inputs_192, outputs_192, co_ind_192 = ct_192.con_td()


save_folder_path = 'traindata4_npy'
np.save(os.path.join(save_folder_path, 'inputs_4.npy'), inputs_4)
np.save(os.path.join(save_folder_path, 'outputs_4.npy'), outputs_4)
...
np.save(os.path.join(save_folder_path, 'coordinate_index_4.npy'), co_ind_4)
